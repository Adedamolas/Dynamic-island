...
export default function Island() {
    return (
      <div className=" mobile_island flex flex-row w-full justify-center items-start place-items-center fixed h-[100vh] pt-[1.2rem] sm:max-2xl:pt-[5.05rem] sm:max-2xl:hidden">
        <motion.div
          transition={{ duration: 0.25 }}
          whileHover={{ scale: 3.5, y: 0 }}
          initial={{ scale: 1 }}
          className="
